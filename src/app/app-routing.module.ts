...
const routes: Routes = [
  ...
  { path: 'create-funnel-stats', component: CreateFunnelStatsComponent, canActivate: [AuthGuard] },
  { path: 'create-funnel-contacts', component: CreateFunnelContactsComponent, canActivate: [AuthGuard] },
  { path: 'create-funnel-sales', component: CreateFunnelSalesComponent, canActivate: [AuthGuard] },
  { path: 'create-funnel-settings', component: CreateFunnelSettingsComponent, canActivate: [AuthGuard] },
