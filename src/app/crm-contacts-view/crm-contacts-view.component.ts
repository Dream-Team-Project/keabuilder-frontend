...
@Component({
  selector: 'app-crm-contacts-view',
  templateUrl: './crm-contacts-view.component.html',
  styleUrls: ['./crm-contacts-view.component.css'],
})
export class CrmContactsViewComponent implements OnInit {
