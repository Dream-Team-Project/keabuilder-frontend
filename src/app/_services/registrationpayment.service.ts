...
import { catchError, of, Observable, BehaviorSubject, throwError } from 'rxjs';
...
registrationpayment(data:any): Observable<any>{
  return this.http.post('/api/registrationpayment',data).pipe(catchError(this.errorHandler));
}

getsubscriptiondata(): Observable<any>{
  return this.http.get('/api/subscriptiondata/'+this.user_id).pipe(catchError(this.errorHandler));
} 
updatestripedata(obj:any): Observable<any>{
