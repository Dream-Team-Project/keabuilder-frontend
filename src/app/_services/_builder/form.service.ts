...
export class FormService {
  ...
  formEle:any = [
    ...
    {name:'split-text', label: 'Name', icls: 'far fa-user', required: true, split: [
    ...
    {name:'phone', label: 'Phone', type:'tel', placeholder: 'phone number', icls: 'fas fa-phone', required: false},
    {name:'address', label: 'Address', icls: 'fas fa-address-card', required: true, split: [
      ...
      {subsplit: [
        ...
        {name:'country', label:'Country', type:'select', placeholder: 'Country', options: this.countries},
      ]}
    ]},
    ...
    {name:'radio', label:'Single choice', icls: 'far fa-dot-circle', required: false, split: [
    ...
    {name:'checkbox', label:'Multiple choice', icls: 'far fa-check-square', required: false, split: [
