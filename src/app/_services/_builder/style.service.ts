...
'Courier New',
 ...
 'Georgia',
  ...
  // font_family_types = ['ABeeZee','Abel','Abhaya Libre','Arial', 'Arial Black', 'Courier New', 'cursive', 'fantasy', 'Georgia', 'Helvetica', 'Impact', 'Lucida Console', 'Lucida Sans Unicode', 'monospace', 'poppins', 'sans-serif', 'serif', 'Tahoma', 'Times New Roman', 'Verdana'];
  ...
  updateStyle() {
    ...
    if(this._general.selectedBlock.type == 'main') {
      ...
      this._general.main.page_code = this._general.page_code;
  ...
  blockSetting(block: any) {
      ...
      if(!this._general.isObjEmpty(obj)) {
        ...
        if (block.type == 'row') {
          ...
          this._general.page_code = block.page_code;
