...
export class FieldService {
  ...
  fieldTypes:Array<any> = [
    { name: 'phone', label: 'Phone', type: 'tel', tag: '', placeholder: 'Phone Number', icon: '<i class="fas fa-phone"></i>', value: '', required: false},
    {
      name: 'address', label: 'Address', icon: '<i class="fas fa-address-card"></i>', required: true, default: true, split: [
        { 
          subsplit: [
    ...
    {
      name: 'split-text', label: 'Split Text', tag: '', type: 'text', icon: '<i class="far fa-hand-scissors"></i>', required: false, split: [
  ...
  fields:Array<any> = [
    {
      name: 'name', label: 'Name', icon: '<i class="far fa-user"></i>', required: true, default: true, split: [
